...
def scores(fenetre,choix,largeur,hauteur,fond) :
    ...
    font=pygame.font.Font(filepath("font/segoesc.ttf"), 60)
    
    CreateDataBase = sqlite3.connect('Base_de_données.sq3')# on crée une base de donnée temporaire
    QueryCurs = CreateDataBase.cursor()
    QueryCurs.execute('SELECT * FROM temps')

    print QueryCurs.fetchone()
    print QueryCurs.fetchone()
    print QueryCurs.fetchone()
    print QueryCurs.fetchone()
    print QueryCurs.fetchone()

    text = font.render("1.",1,(0,0,0))
    text2 = font.render("2.",1,(0,0,0))
    text3 = font.render("3.",1,(0,0,0))
    text4 = font.render("4.",1,(0,0,0))
    text5 = font.render("5.",1,(0,0,0))
    text6= font.render("7 secondes",1,(0,0,0))
    text7 = font.render("15 secondes",1,(0,0,0))
    text8 = font.render("28 secondes",1,(0,0,0))
    text9 = font.render("38 secondes",1,(0,0,0))
    text10 = font.render("41 secondes",1,(0,0,0))
    ...
    while continuer:
        ...
        fenetre.blit(fond ,(0,0))
        fenetre.blit(SCORES, position_SCORES)
        fenetre.blit(text, (700, 250))
        fenetre.blit(text2, (700, 350))
        fenetre.blit(text3, (700, 450))
        fenetre.blit(text4, (700, 550))
        fenetre.blit(text5, (700, 650))
        fenetre.blit(text6, (900, 250))
        fenetre.blit(text7, (900, 350))
        fenetre.blit(text8, (900, 450))
        fenetre.blit(text9, (900, 550))
        fenetre.blit(text10, (900, 650))
